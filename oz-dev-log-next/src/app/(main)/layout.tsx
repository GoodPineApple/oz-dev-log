    ...
    <div className="min-h-svh bg-zinc-50 dark:bg-zinc-950">
      <header className="sticky top-0 z-40 border-b border-zinc-200/80 bg-white/90 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/90">
        <div className="mx-auto flex max-w-2xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          ...
          >
            DevLog<span className="ml-1 text-xs font-normal text-violet-500">Next</span>
          </Link>
          <nav className="flex flex-wrap items-center gap-1">
            <NavLink href="/">타임라인</NavLink>
            <NavLink href="/logs/new">기록하기</NavLink>
            <NavLink href="/me">마이</NavLink>
          </nav>
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800">
        <div className="mx-auto max-w-2xl space-y-2 px-4 py-6 text-center text-xs text-zinc-400">
          <div className="flex justify-center gap-3">
            <Link href="/api-docs" className="hover:text-violet-600">
              API 문서 (Swagger)
            </Link>
          </div>
          <p>DevLog Next — Next.js 풀스택 학습용 데모</p>
        </div>
      </footer>
    </div>
  );
